...
defineExpose({ handleSetFilter, scrollTo });
</script>

<template>
  <HeroSection
    @scroll-to-menu="scrollToMenu"
    @open-cart="cart.showCart = true"
  />
  ...
  <CartSidebar
    ...
    @open-checkout="cart.showCart = false; showCheckout = true"
    @open-history="cart.showCart = false; showHistory = true"
  />

...
const ICONS = {
  ...
  clocktower: ['M12 1.6l3.4 2.4H8.6L12 1.6z', 'M6.5 4h11a1 1 0 0 1 1 1v14h-13V5a1 1 0 0 1 1-1z', 'circle:12,11.8,3.3', 'M12 11.8V9.2', 'M12 11.8l-2.1-1.6', 'M5.5 20h13'],
  creditcard: ['rect:2,7,20,11,2', 'M2 10.5h20', 'M6 15.5h4'],
  shield: ['M12 2l8 3v6c0 4.6-3.2 8.9-8 11-4.8-2.1-8-6.4-8-11V5l8-3z', 'm9 12 2 2 4-4'],
  bolt: ['M13 2 4.5 13.5H11L9.5 22 19 10h-6.5L13 2z'],
  heart: ['M12 21s-7.5-4.6-9.5-9a5.2 5.2 0 0 1 9.5-3.1A5.2 5.2 0 0 1 21.5 12c-2 4.4-9.5 9-9.5 9z'],
